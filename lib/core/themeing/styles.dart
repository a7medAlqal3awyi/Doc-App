...
class TextStyles {
  ...
  static TextStyle font14lightGreyW500 = TextStyle(
    fontSize: 14.sp,
  ...
  static TextStyle font14moreLighterGreyW400 = TextStyle(
    fontSize: 13.sp,
    fontWeight: FontWeight.w400,
    height: 1.5,
    color: ColorManager.moreLighterGrey,
  );
  static TextStyle font13darkBlueW500 = TextStyle(
    fontSize: 14.sp,
    fontWeight: FontWeight.w600,
    height: 1.5,
    color: ColorManager.darkBlue,
 ...
 static TextStyle font14DarkBlueW600 = TextStyle(
    fontSize: 14.sp,
    fontWeight: FontWeight.w600,
    color: ColorManager.darkBlue,
  );
